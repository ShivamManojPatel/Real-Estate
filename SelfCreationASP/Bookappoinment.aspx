<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Bookappoinment.aspx.cs" Inherits="SelfCreationASP.Bookappoinment" %>
			...
			<div class="col-md-12">
				<form method="post" action="" runat="server">
					...
					<div class="form-group">
						<h6>Pick Date</h6>
						<asp:textbox id="bdate" placeholder="Enter date(yyyy-mm-dd)" runat="server" class="form-control"/>
					</div><hr>
					<!-- time -->
					<div class="form-group">
						<h6>Pick Time</h6>
						<asp:textbox id="btime" placeholder="Enter time(HH-mm)" runat="server" class="form-control"/>
					</div><hr>
					<!-- venue -->
					<div class="form-group">
						<h6>Enter venue address</h6>
						<asp:TextBox id="baddress" runat="server" TextMode="MultiLine" Height="100" placeholder="Enter Address" CssClass="form-control"></asp:TextBox>
					</div><hr>
					<div class="form-group">
						<asp:Button ID="Abtn" runat="server" Text="Book" class="btn btn-block btn-primary" OnClick="Abtn_Click1"/>
					</div>
				</form>
			</div>
		</div>
